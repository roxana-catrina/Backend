...
public class NotificareController {
    ...
    public ResponseEntity<List<NotificareDTO>> getNotificari(@PathVariable Long userId) {
    ...
    public ResponseEntity<List<NotificareDTO>> getNotificariNecitite(@PathVariable Long userId) {
    ...
    public ResponseEntity<Long> countNotificariNecitite(@PathVariable Long userId) {
    ...
    public ResponseEntity<Void> marcheazaCaCitita(@PathVariable Long notificareId) {
    ...
    public ResponseEntity<Void> marcheazaToateCaCitite(@PathVariable Long userId) {
    ...
    public ResponseEntity<Void> stergeNotificare(@PathVariable Long notificareId) {
    ...
    public ResponseEntity<Void> stergeToateNotificarile(@PathVariable Long userId) {
